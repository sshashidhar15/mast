...
module.exports.up = next => {
    ...
    redis((_, db) =>
        Promise.all(
                    ...
                    .then(_ => {
                        ...
                        return Object.keys(_).reduce(
                            (_, lang) => {
                                ...
                                if (_[lang] && _[lang]['pages'] && _[lang]['pages']['index'] && _[lang]['pages']['index']['home_block3_button']) {
                                    _[lang]['pages']['index']['home_block3_button'] = en
                                } else {
                                    console.error(key, lang, 'no expected key: [pages.index.home_block3_button]')
                                }
            ...
            .then(() => {
                console.error('Migration "Raw Pricing Benefits" (for all languages) up done')
                next()
            })
            .catch(e => {
